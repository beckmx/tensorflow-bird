...
// Change with your wifi credential
...
void setup() {
  ...
  timer.setInterval(1000, send_inference); // Setting Timer
}
...
void send_inference()
{
  ...
  if(WiFi.status() == WL_CONNECTED && inClassificationProcess==false) {
    classify_loop();
  }
}
